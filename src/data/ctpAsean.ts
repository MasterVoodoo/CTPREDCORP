...
export const ctpAseanBuildingInfo: BuildingInfo = {
  ...
  location: "Asean Drive, Filinvest City, Alabang, Muntinlupa",
  shortLocation: "Asean Drive, Filinvest City, Alabang, Muntinlupa",
  description: [
...
export const ctpAseanUnits: { [key: string]: Unit } = {
  "CRC-GF12": {
    ...
    availability: {
      ...
      additionalCosts: ["HVAC: ₱100", "Parking: ₱150"]
    }
  },
  "CRC-1001": {
    id: "CRC-1001",
  ...
  "CRC-LP03": {
    ...
    availability: {
      ...
      includedUtilities: ["Security", "Cleaning"],
      additionalCosts: ["HVAC: ₱200", "Parking: ₱200"]
    }
  },
  "CRC-LP04": {
    id: "CRC-LP04",
  ...
  "CRC-UP02": {
    ...
    availability: {
      ...
      includedUtilities: ["Security", "Cleaning"],
      additionalCosts: ["HVAC: ₱250", "Parking: ₱300"]
    }
  }
};

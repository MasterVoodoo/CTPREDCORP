  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <style>{`
        ...
        .tab-button.active { background-color: #2563EB !important; color: white !important; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.3); }
        .tab-button.active svg { color: white !important; }
        .quick-action-card { transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
        .quick-action-card:hover { transform: translateY(-4px); border-color: #2563EB !important; background-color: #EFF6FF !important; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); }
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div onClick={() => navigate('/admin/content')} className="quick-action-card flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg cursor-pointer">
                    ...
                    <div className="text-left"><p className="font-medium text-gray-900">Manage Content</p><p className="text-sm text-gray-600">Update buildings and units</p></div>
                  </div>
                  <div onClick={() => window.location.href = '/#sustainability-financial-reports'} className="quick-action-card flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg cursor-pointer">
                    ...
                    <div className="text-left"><p className="font-medium text-gray-900">View Reports</p><p className="text-sm text-gray-600">Financial and analytics</p></div>
                  </div>
                </div>
              </div>
            </div>
